  ...
  return (
    <section className="relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0 z-0" aria-hidden="true">
        ...
        <div className="absolute -top-16 right-[-120px] w-[380px] h-[380px] rounded-full bg-terracotta/25 blur-[110px]" />
      ...
      <div className="relative z-10 max-w-[920px] mx-auto text-center px-8 pb-[90px] pt-[130px] md:pt-[150px]">
        <img
          src={convitePetal}
          alt=""
          aria-hidden="true"
          className="w-[72px] h-[72px] mx-auto mb-8 drop-shadow-[0_8px_30px_rgba(42,26,43,0.15)]"
        />
